...
from Music import BOT_NAME, USERNAME, app, client
...
print(f"[INFO]: ASSISTANT STARTED AS {USERNAME}!")
...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO ANONYMOUS_MUSIC SERVER")
        try:
    ...
    for served_chat in served_chats:
        try:
            ...
            print("Error came while clearing db")
            pass     
    await app.send_message(LOG_GROUP_ID, "Anonymous_Music Bot Started")
    await client.send_message(LOG_GROUP_ID, "Assistant Of Anonymous_Music Started")
    print("[INFO]: STARTED THE ANONYMOUS BOT AND SENDING THE INFO TO ANONYMOUS SERVER")
