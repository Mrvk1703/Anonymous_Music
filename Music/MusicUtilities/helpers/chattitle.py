# Convert normal font chat titles to special title
async def CHAT_TITLE(ctitle):
    ...
    font6 = list("🅐🅑🅒🅓🅔🅕🅖🅗🅘🅙🅚🅛🅜🅝🅞🅟🅠🅡🅢🅣🅤🅥🅦🅧🅨🅩")
    font7 = list("ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ")
    font25 = list("ᴀʙᴄᴅᴇꜰɢʜɪᴊᴋʟᴍɴᴏᴘǫʀsᴛᴜᴠᴡxʏᴢ")
    ...
    for XCB in font1:
        ...
        string = string.replace(font6[cout],normalL[cout])
        ...
        string = string.replace(font25[cout],normalL[cout])
