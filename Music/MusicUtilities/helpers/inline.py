...
play_list_keyboard = InlineKeyboardMarkup( 
            [
                ...
                [
                    InlineKeyboardButton(text=f"✨ ɢʀᴏᴜᴘ", url=f"https://telegram.me/{ANOMYMOUSROBOTSUPPORT}"),
                    InlineKeyboardButton(text=f"📣 ᴄʜᴀɴɴᴇʟ", url=f"https://telegram.me/{UPDATES_CHANNEL}"),
                ],
                [
                    InlineKeyboardButton(
                        "ᴄʟᴏsᴇ", callback_data="close2"
